...
public class Compost4_FillHeight extends MosaicEditorApplet {
	...
	public void setup() {
		...
		MosaicEditorAppletSettings settings = new MosaicEditorAppletSettings(
				mosInfo, "/Users/Nils/Documents/Kunst/Compost/Compositions/",
				mosDrawer);

		FilterCommand fillHeightFilter = new JarFillHeightFilter(true);
		FilterCommand mapFilter = new MapFilter(mosInfo.xdim * mosInfo.ydim
				+ 10);
		...
		try {
			imageProvider = new FilterableMultiImageProvider(
					"/Users/Nils/Documents/Kunst/Compost/Images/eighthsize/compostimages.dat");
