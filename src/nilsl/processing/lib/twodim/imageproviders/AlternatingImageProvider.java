...
public class AlternatingImageProvider extends ImageProvider implements
		Resetable {

	private Counter1d counter;
	private List<ImageProvider> imageProviders;
	static final Logger logger = LogManager
			.getLogger(AlternatingImageProvider.class.getName());
	...
	public void getNextImage(PGraphics buffer) {
		...
		while (!imageFound) {
			ImageProvider currentProvider = imageProviders.get(counter
					.getCurPos());
